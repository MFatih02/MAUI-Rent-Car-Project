...
public partial class Detay_Sandero : ContentPage
{
    private readonly ICarService carService;

    public ObservableCollection<AracModelM> anabilgi { get; set; }
    
    public Detay_Sandero()
	{
        InitializeComponent();
    ...
    private async void LoadBilgi()
    {
        ...
        anabilgi = new ObservableCollection<AracModelM>(araclar.Where(x => x.Model.Contains("Sandero")));
