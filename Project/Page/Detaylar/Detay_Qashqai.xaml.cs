...
public partial class Detay_Qashqai : ContentPage
{
    ...
    private async void LoadBilgi()
    {
        ...
        anabilgi = new ObservableCollection<AracModelM>(araclar.Where(x => x.Model.Contains("Qashqai")));
